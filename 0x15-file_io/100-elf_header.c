 ...
 *
 * Return: 0 if the first n bytes of s1 and s2 are equal, otherwise not zero
 */
...
/**
 * _read - reads from the file and print an error message if fails
...
/**
 * elf_version - print the ELF version
 * @buffer: ELF header
 */
...
/**
 * elf_osabi - it prints ELF OS/ABI
 * @buffer: ELF header
 */
...
/**
 * elf_abivers - it prints ELF ABI version
 * @buffer: ELF header
 */
...
/**
 * elf_type - it prints ELF type
 * @buffer: ELF header
 * @big_endian: endi anness (big endian if not zero)
 */
...
/**
 * elf_entry - it prints the entry point address
 * @buffer: str containing the entry point address
